...
provider "aws" {
  region = "ca-central-1"
  access_key = "AKIAXYHY7IJV67NQ6GFO"
  secret_key = "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"
}
  ...
  "Statement": [
    {
      ...
      "Resource": ["arn:aws:logs:::*", "${aws_dynamodb_table.lotion-30140219.arn}"],
      "Effect": "Allow"
    }
  ]
}
...
resource "aws_dynamodb_table" "lotion-30140219" {
  name         = "lotion-30140219"
